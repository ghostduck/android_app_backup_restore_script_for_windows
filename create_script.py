...
#
# This script creates batch file to backup up your Android apps using Windows.
#
# You should enable USB debugging in your Android device, then run the generated
# script to backup your app.
#
# Usage for this script: Update the params in main() manually then run this
# script to generate your own batch file.
#
# Note: Look at the generated script to understand how and why this script works
#
...
# NOTE: I know MD5 is not secure but good enough for purpose of forcing
# same input to generate same filename
def var_digest(i):
...
def generate_batch(p):
    ...
    # Step 1: Setup params
    # var_digest(p) generates same hash value for same p
...
#
# Finally, I don't recommend having more than 5 items here. That would be too
# long in DOS window. I recommend building separate scripts instead.
#
def main():
    ...
    params = (
        ...
        # (app id,
        #  display name in batch file,
        #  (optional)True if you want to backup both data and APK
        # )
